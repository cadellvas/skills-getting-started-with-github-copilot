...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball team practicing offensive and defensive plays",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Lap swimming, stroke improvement, and swim meets",
    ...
    "Science Olympiad": {
        "description": "Hands-on science competitions and team problem solving",
